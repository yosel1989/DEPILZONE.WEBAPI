...
namespace DepilZone.Data.Interface
{
    public interface ICitaDom
	{
		...
		Task<IEnumerable<CitaDTO>> Obtener(DateTime fecha, string horaInicio, string horaTermino, int idSede, int idEstado, string pacienteCelular, int tipoCita, int idServicio);
