	...
	public class TipoClienteDat : ITipoClienteDat
	{
        public async Task<List<TipoClienteDTO>> Listar()
        {
            try
            {
                ...
                using SqlCommand cmd = new SqlCommand("C360_SP_TipoCliente_Listar", conn)
                {
        ...
        public async Task<List<TipoClienteDTO>> ListarByEstado(int idEstado)
        {
            try
            {
                using SqlConnection conn = DBConn.ConexionSQL();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("C360_SP_TipoCliente_ListarByEstado", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
        ...
        public async Task<bool> Registrar(TipoClienteDTO model)
        {
            try
            {
                using SqlConnection conn = DBConn.ConexionSQL();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("C360_SP_TipoCliente_Registrar", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
        ...
        public async Task<bool> Modificar(int id, TipoClienteDTO model)
        {
            try
            {
                using SqlConnection conn = DBConn.ConexionSQL();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("C360_SP_TipoCliente_Modificar", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
        ...
        static async Task<List<TipoClienteDTO>> ReadListar(DbDataReader reader)
        {
            try
            {
                List<TipoClienteDTO> collection = new List<TipoClienteDTO>();
                while (await reader.ReadAsync())
                {
                    TipoClienteDTO obj = new TipoClienteDTO();
